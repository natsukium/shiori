...
CREATE INDEX IF NOT EXISTS pgroonga_title_index ON bookmark USING pgroonga (title);
CREATE INDEX IF NOT EXISTS pgroonga_excerpt_index ON bookmark USING pgroonga (excerpt);
CREATE INDEX IF NOT EXISTS pgroonga_content_index ON bookmark USING pgroonga (content);